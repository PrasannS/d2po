...
export SEED=3
# sh script/bon_script.sh "unique_nns" "ultra" "functionunique_nns" 29526 "uniquebasebon"

export STEPS=500
export CUDA_VISIBLE_DEVICES=3,4
export SEED=3
# sh script/bon_script.sh "bagofwords" "ultra" "functionbagofwords" 29527 "bowbon"
export SEED=3
...
export SEED=3
export PPOUPDATES=1
sh script/bon_script.sh "math" "outputs/data/math/mathppoinps200k" "functionmath" 29526 "mathbontest"
export SEED=3
