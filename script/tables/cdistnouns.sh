...
export CUDA_VISIBLE_DEVICES=1
# noupdateapi "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "reprodtest" 5000
nohup sh script/newupdateapi.sh "nouns" "" "tiny_rm" "randnoun_newalgo_100small_200testv3" 5009 & 
sleep 20
# Other commands
export CUDA_VISIBLE_DEVICES=0,4
sh script/dpoplus_script.sh "nouns" "ultra" "http://127.0.0.1:5009/train" 29520 "randnoun_newalgo_100small_200testv3"
jobs
pkill -f "randnoun_newalgo_100small_200testv3"
jobs
...
export CUDA_VISIBLE_DEVICES=1
# noupdateapi "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "reprodtest" 5000
nohup sh script/newupdateapi.sh "nouns" "" "tiny_rm" "confnoun_newalgo_100small_200testv3" 5009 & 
sleep 20
# Other commands
export CUDA_VISIBLE_DEVICES=0,4
sh script/dpoplus_script.sh "nouns" "ultra" "http://127.0.0.1:5009/train" 29520 "confnoun_newalgo_100small_200testv3"
jobs
pkill -f "confnoun_newalgo_100small_200testv3"
jobs
