...
nohup sh script/updateapi.sh "math" "" "tiny_rm" "conf_subsamp_bigrollout" 5004 & 
sleep 10
# Other commands
export CUDA_VISIBLE_DEVICES=4,5
sh script/dpoplus_script.sh "math" "outputs/data/math/mathppoinps" "http://127.0.0.1:5004/train" 29519 "conf_subsamp_bigrollout"
jobs
pkill -f "conf_subsamp_bigrollout"
jobs
...
export CUDA_VISIBLE_DEVICES=3
# noupdateapi "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "reprodtest" 5000
nohup sh script/updateapi.sh "contrastivedistill" "" "tiny_rm" "conf_subsamp_bigrollout" 5004 & 
# Other commands
export CUDA_VISIBLE_DEVICES=4,5
sh script/dpoplus_script.sh "contrastivedistill" "outputs/data/contrastivedistill/wikionpolicyprompts" "http://127.0.0.1:5004/train" 29522 "conf_subsamp_bigrollout"
jobs
pkill -f "conf_subsamp_bigrollout"
jobs