...
# noupdateapi "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "reprodtest" 5000
nohup sh script/newupdateapi.sh "math" "" "mathbigdata1b" "1bjustoffpolicyrmupper" 5005 & 
# Other commands
export CUDA_VISIBLE_DEVICES=1,2
sh script/dpoplus_script.sh "math" "outputs/data/math/mathppoinps200k" "http://127.0.0.1:5005/train" 29522 "1bjustoffpolicyrmupper"
jobs
pkill -f "1bjustoffpolicyrmupper"
jobs
