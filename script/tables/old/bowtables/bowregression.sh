...
nohup sh script/updateapi.sh "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "conf_all_reg" 5002 & 
# Other commands
export CUDA_VISIBLE_DEVICES=1,2
sh script/dpoplus_script.sh "bagofwords" "ultra" "http://127.0.0.1:5002/train" 29517 "conf_all_reg"
jobs
pkill -f "conf_all_reg"
jobs
