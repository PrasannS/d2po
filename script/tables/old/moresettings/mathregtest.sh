# SH File for regression test to sanity check that code is running fine
...
export ATYPE="rand"
# rand SUBSAMPLING RUN MATH
export CUDA_VISIBLE_DEVICES=3
# noupdateapi "bagofwords" "bowsynth50knozeros" "bowtiny_rm" "reprodtest" 5000
nohup sh script/updateapi.sh "math" "" "tiny_rm" "rand_subsamp_onlymathregression" 5004 & 
# Other commands
export CUDA_VISIBLE_DEVICES=4,5
sh script/dpoplus_script.sh "math" "outputs/data/math/mathppoinps" "http://127.0.0.1:5004/train" 29519 "rand_subsamp_onlymathregression"
jobs
pkill -f "rand_subsamp_onlymathregression"
jobs
