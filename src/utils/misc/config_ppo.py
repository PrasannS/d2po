...
# originally was using TRL Version: 0.7.6
import json
import os
import sys
import warnings
...
class PPOConfig:
    ...
    # HACK added dpoplus option
    """Initial KL penalty coefficient (used for adaptive and linear control)"""
    kl_penalty: Literal["kl", "abs", "mse", "full", "dpoplus", "ipo"] = "kl"
    ...
    def __post_init__(self):
        ...
        assert self.kl_penalty in ["kl", "abs", "mse", "full", "dpoplus", "ipo"]
